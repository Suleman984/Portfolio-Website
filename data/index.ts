...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    img: "/images/lead-generation.png",
    emoji: "🎯",
...
export const SERVICES = [
  ...
  },
  {
    ...
    icon: "⚙️",
    title: "Backend & APIs",
    desc: "Scalable server-side systems with Node.js and Golang. RESTful APIs, GraphQL endpoints, JWT auth, and database design that scales.",
    tags: ["Node.js", "Golang", "GraphQL", "PostgreSQL"],
  },
  {
    num: "03",
    icon: "🤖",
    title: "Automation & Workflows",
    desc: "Automated integration pipelines that save hours of manual work. API-to-API workflows, data pipelines, and process automation.",
    tags: ["Versori", "REST APIs", "Webhooks"],
  },
  {
    num: "04",
    icon: "📱",
  ...
  },
  {
    ...
    desc: "Dashboards, POS systems, and reporting pipelines. From raw data to actionable insights with clean visualizations.",
    tags: ["Python", "Pandas", "Matplotlib", "Charts"],
  },
  {
    num: "06",
    icon: "🚀",
